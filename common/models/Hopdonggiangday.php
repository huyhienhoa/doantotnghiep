...
/**
 * This is the model class for table "{{%hopdonggiangday}}".
 *
 * @property int $id
 ...
 */
class Hopdonggiangday extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function beforeSave($insert)
    {
        ...
        if(is_null($file)){
            if($insert){
                ...
                $old = Hopdonggiangday::findOne($this->id);
