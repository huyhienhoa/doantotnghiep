...
use Yii;
use common\models\Thoikhoabieu;
use common\models\searchs\ThoikhoabieuSearch;
...
/**
 * ThoikhoabieuController implements the CRUD actions for Thoikhoabieu model.
 */
class ThoikhoabieuController extends Controller
{
    ...
    /**
     * Lists all Thoikhoabieu models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ThoikhoabieuSearch();
    ...
    /**
     * Displays a single Thoikhoabieu model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Thoikhoabieu model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Thoikhoabieu();
    ...
    /**
     * Updates an existing Thoikhoabieu model.
    ...
    /**
     * Deletes an existing Thoikhoabieu model.
    ...
    /**
     * Finds the Thoikhoabieu model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Thoikhoabieu the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Thoikhoabieu::findOne($id)) !== null) {
            return $model;
        }
