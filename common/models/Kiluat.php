...
/**
 * This is the model class for table "{{%kiluat}}".
 *
 * @property int $id
 ...
 */
class Kiluat extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['name', 'giangvien_id', 'namhoc_id'], 'required', 'message' => 'Chưa điền {attribute}'],
