...
class Dkthiduatapthe extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'sogiangvien', 'sogiangviencomat', 'CTNA_GDLT', 'CTNA_HDTH', 'CTNA_HDTN', 'CTNA_CT', 'CTNA_KN', 'CTNB_VGT', 'CTNB_NCKH', 'CTNB_CMNV', 'CTNB_TGPT', 'CTNB_CHPL'], 'required', 'message' => 'Chưa điền {attribute}'],
