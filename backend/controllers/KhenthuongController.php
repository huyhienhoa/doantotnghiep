...
use Yii;
use common\models\Khenthuong;
use common\models\searchs\KhenthuongSearch;
...
/**
 * KhenthuongController implements the CRUD actions for Khenthuong model.
 */
class KhenthuongController extends Controller
{
    ...
    /**
     * Lists all Khenthuong models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new KhenthuongSearch();
    ...
    /**
     * Displays a single Khenthuong model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Khenthuong model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Khenthuong();
    ...
    /**
     * Updates an existing Khenthuong model.
    ...
    /**
     * Deletes an existing Khenthuong model.
    ...
    /**
     * Finds the Khenthuong model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Khenthuong the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Khenthuong::findOne($id)) !== null) {
            return $model;
        }
