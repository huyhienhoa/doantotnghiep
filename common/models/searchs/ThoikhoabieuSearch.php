...
/**
 * ThoikhoabieuSearch represents the model behind the search form of `common\models\Thoikhoabieu`.
 */
class ThoikhoabieuSearch extends Thoikhoabieu
{
    /**
     * @inheritdoc
     */
