...
class Dkthiduacanhan extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'hoten','danhhieu', 'chucvu', 'CTNA_GDLT', 'CTNA_HDTH', 'CTNA_HDTN', 'CTNA_CT', 'CTNA_KN', 'CTNB_NCKH', 'CTNB_VGT', 'CTNB_VCDKH', 'CTNB_CMNV', 'CTK_TGPT', 'CTK_CHPL'], 'required', 'message' => 'Chưa điền {attribute}'],
            [['khoa_id', 'namhoc_id'], 'integer'],
            [['ngaydk', 'created_at', 'updated_at', 'ngaysinh'], 'safe'],
            [['name', 'hoten', 'chucvu', 'CTNA_GDLT', 'CTNA_HDTH', 'CTNA_HDTN', 'CTNA_CT', 'CTNA_KN', 'CTNB_NCKH', 'CTNB_VGT', 'CTNB_VCDKH', 'CTNB_CMNV', 'CTK_TGPT', 'CTK_CHPL','danhhieu'], 'string', 'max' => 100],
