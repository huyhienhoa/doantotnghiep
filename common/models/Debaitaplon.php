...
/**
 * This is the model class for table "{{%debaitaplon}}".
 *
 * @property int $id
 ...
 */
class Debaitaplon extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['name', 'nhomhocphan', 'hocky_id', 'namhoc_id', 'monhoc_id'], 'required', 'message' => 'Chưa điền {attribute}'],
            [['created_at', 'updated_at'], 'safe'],
            [['hocky_id', 'namhoc_id', 'monhoc_id', 'DBTL_DCOT_LT_PCCT_id'], 'integer'],
            [['name'], 'string', 'max' => 50],
    ...
    public function beforeSave($insert)
    {
        ...
        if(is_null($file)){
            if($insert){
                ...
                $old = Debaitaplon::findOne($this->id);
